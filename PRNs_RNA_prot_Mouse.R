...
ggsave("output_files/Mouse_histograms.pdf", pH, width = 14, height = 4.9, units = "cm")
...
DT_summary <- DT_prn[, .(median_prn_rho = median(rho, na.rm = TRUE)), by = .(cor_type, Progulon_ID) ]
...
p1
ggsave("output_files/Mouse_Example_histograms.pdf", p1,
...
p2 <- ggplot(DT_summary, aes(x = med_RNA_RNA_rho, y = med_pro_pro_rho))+
        ...
        geom_text(data = DT_summary[ Progulon_ID %in% c("P25", "P04","P05", "P11", "P31", "P29", "P21", "P09", "P23")],
...
p2 
ggsave("output_files/Mouse_RNARNAvsProPro_scatter_updated.pdf", p2,
...
p3
ggsave("output_files/Mouse_RNAtoPro_Subset_boxplot.pdf", p3,
...
p4
ggsave("output_files/Mouse_RNAtoPro_boxplot.pdf", p4,
...
fwrite( DT_summary , "output_files/Mouse_Rna_Pro_PRN.csv" )
DT_summary <- fread("output_files/Mouse_Rna_Pro_PRN.csv")
...
p5 <- ggplot(DT_summary, aes(x = med_mRNA_mad, y = med_prot_mad))+
        ...
        geom_point( alpha = 0.5, size = 1 )+
        geom_text(data = DT_summary[ Progulon_ID %in% c("P25", "P09", "P31","P05","P04")], aes(label = prn_function), size = 2, colour = "blue", hjust = -0.1)+
        scale_x_continuous( limits = c(0.6,1.7), expand = c(0,0), breaks = seq(0,2,0.2))+
        scale_y_continuous( limits = c(0.4,1.6), expand = c(0,0), breaks = seq(0,2,0.2))+
        xlab("Scale of mRNA expression variation [median MAD]")+
        ylab("Scale of protein expression variation [median MAD]")+
        annotate(geom = "text", x = 0.7, y = 1.5, size = 2, hjust = 0, label = sigrho )+      
        annotate(geom = "text", x = 0.7, y = 1.4, size = 2, hjust = 0, label = sigRHO )+      
        theme(plot.background = element_blank(), panel.background = element_rect(fill=NA, colour="black", size = 0.25),
              panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
              axis.title = element_text(size = 6), axis.text = element_text(size = 5, colour = "black"),
              legend.position = "none", axis.ticks = element_line(size = 0.25))
...
p5 
ggsave("output_files/Mouse_Scale_RNAvsPro.pdf", p5,
...
p6 <- ggplot(DT_summary, aes(x = med_RNA_pro_rho, y = med_prot_mad))+
      ...
      geom_text(data = DT_summary[ Progulon_ID %in% c("P25", "P09", "P26","P23","P04","P05")],
                aes(label = prn_function), size = 2, colour = "blue", hjust = -0.1)+
      scale_x_continuous( limits = c(-0.1,0.65), expand = c(0,0), breaks = seq(-0.1,1,0.1))+
      scale_y_continuous( limits = c(0.3,1.5), expand = c(0,0), breaks = seq(0,2,0.2))+
      xlab("mRNA-to-protein correlation [median rho]")+
      ylab("Scale of protein expression variation [median MAD]")+
      annotate(geom = "text", x = 0.2, y = 1.4, size = 2, hjust = 0, label = sigrho )+      
      annotate(geom = "text", x = 0.2, y = 1.3, size = 2, hjust = 0, label = sigRHO )+      
      theme(plot.background = element_blank(), panel.background = element_rect(fill=NA, colour="black", size = 0.25),
            panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
            axis.title = element_text(size = 6), axis.text = element_text(size = 5, colour = "black"),
            legend.position = "none", axis.ticks = element_line(size = 0.25))
...
p6
ggsave("output_files/Mouse_Scale_RNAtoPro.pdf", p6,
       width = 4.5, height = 4.5, units = "cm")
...
p7 <- ggplot(DT_summary, aes(x = med_RNA_RNA_rho, y = med_mRNA_mad))+
      ...
      annotate(geom = "text", x = 0.5, y = 0.9, size = 2, hjust = 0, label = sigRHO )+      
      theme(plot.background = element_blank(), panel.background = element_rect(fill=NA, colour="black", size = 0.25),
            panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
            axis.title = element_text(size = 6), axis.text = element_text(size = 5, colour = "black"),
            legend.position = "none", axis.ticks = element_line(size = 0.25))
...
p7
ggsave("output_files/Mouse_Scale_RNAtoRNA.pdf", p7,
       width = 4.5, height = 4.5, units = "cm")
...
p8 <- ggplot(DT_summary, aes(x = med_pro_pro_rho, y = med_prot_mad))+
        ...
        geom_text(data = DT_summary[ Progulon_ID %in% c("P25", "P11", "P31", "P29", "P21", "P09", "P23","P26","P04","P05")],
                  aes(label = prn_function), size = 2, colour = "blue", hjust = -0.1)+
        scale_x_continuous( limits = c(-0.05,0.9), expand = c(0,0), breaks = seq(0,1,0.2))+
        scale_y_continuous( limits = c(0.45,1.5), expand = c(0,0), breaks = seq(0,2,0.2))+
        xlab("median protein coexpression [rho]")+
        ylab("Scale of protein expression variation [median MAD]")+
        annotate(geom = "text", x = 0.65, y = 1.0, size = 2, hjust = 0, label = sigrho )+      
        annotate(geom = "text", x = 0.65, y = 0.9, size = 2, hjust = 0, label = sigRHO )+      
        theme(plot.background = element_blank(), panel.background = element_rect(fill=NA, colour="black", size = 0.25),
              panel.grid.major = element_blank(), panel.grid.minor = element_blank(),
              axis.title = element_text(size = 6), axis.text = element_text(size = 5, colour = "black"),
              legend.position = "none", axis.ticks = element_line(size = 0.25))
...
p8
ggsave("output_files/Mouse_Scale_ProToPro.pdf", p8,
       width = 4.5, height = 4.5, units = "cm")
...
ggsave("output_files/Mouse_Scale_composite.pdf", g,
...
p10 <- ggplot(DT_summary, aes(x = med_RNA_pro_rho, y = -log10(p_RNAtoPRO)))+
  geom_point( alpha = 0.5, size = 1 )+
  geom_vline( xintercept = DT[ Gene_1 == Gene_2 , median(RNA_pro_rho) ], size = 0.25, linetype = "dashed")+
  geom_text(data = DT_summary[ order(med_RNA_pro_rho) ][ c(1:13, 26:31) ],
            aes(label = prn_function), size = 2, colour = "blue", hjust = 1, angle = 90)+
  scale_x_continuous( limits = c(-0.1,0.7), expand = c(0,0), breaks = seq(-0.1,0.7,0.1))+
...
p10 
ggsave("output_files/Mouse_volcano.pdf", p10,
       width = 4.9, height = 4.9, units = "cm")
...
p11 <- ggplot(DT_summary, aes(x = med_RNA_RNA_rho, y = med_RNA_pro_rho))+
        geom_point( alpha = 0.5, size = 1 )+
        geom_smooth( method = "lm", size = 0.25, colour = "orange", se = FALSE, fullrange = TRUE)+
        annotate(geom = "text", x = 0.1, y = 0.65, size = 2, hjust = 0, label = sigRHO_11 )+      
        ...
        scale_y_continuous( limits = c(-0.1,0.7), expand = c(0,0), breaks = seq(-0.1,0.7,0.1))+
        ylab("mRNA to protein correlation [rho]")+
...
p11
ggsave("output_files/Mouse_RNARNAvsmRNAPro.pdf", p11,
       width = 4.9, height = 4.9, units = "cm")
...
p12 <- ggplot(DT_summary, aes(x = med_pro_pro_rho, y = med_RNA_pro_rho))+
        geom_point( alpha = 0.5, size = 1 )+
        geom_smooth( method = "lm", size = 0.25, colour = "orange", se = FALSE, fullrange = TRUE)+
        annotate(geom = "text", x = 0.1, y = 0.65, size = 2, hjust = 0, label = sigRHO_12 )+      
        geom_text(data = DT_summary[ order(med_RNA_pro_rho) ][ c(1:31) ],
                  aes(label = prn_function), size = 2, colour = "blue", hjust = 1, angle = 90)+
        scale_x_continuous( limits = c(-0.05,0.81), expand = c(0,0), breaks = seq(0,1,0.1))+
        scale_y_continuous( limits = c(-0.1,0.7), expand = c(0,0), breaks = seq(-0.1,0.7,0.1))+
        ylab("mRNA to protein correlation [rho]")+
...
p12
ggsave("output_files/Mouse_propro_vsmRNAPro.pdf", p12,
       width = 4.9, height = 4.9, units = "cm")
...
ggsave("output_files/Mouse_combined_plot.pdf", combined_p,
